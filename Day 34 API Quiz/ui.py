...
class QuizInterface:
    ...
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.reset_button = Button(command=self.reset, text='reset', bg=THEME_COLOR)
    ...
    def get_next_question(self):
        ...
        if self.quiz.still_has_questions():
            ...
            self.switch_button_state(DISABLED)
    ...
    def reset(self):
        ...
        self.switch_button_state(NORMAL)

    def switch_button_state(self, status):
        self.true_button.config(state=status)
        self.false_button.config(state=status)
